...
par_list = np.concatenate((["Alpha", "Sigma"], x_feature_desc, ["GP1", "GP2"]))
...
if use_log:
    ...
    x_norm = gpmc.norm_data(x_log) # normalize each feature from 0 to 1
else:
    x_norm = gpmc.norm_data(x_in)
x_gp_norm  = gpmc.norm_data(x_gp)
